...
def option1_2():
    ...
    while status:
        ...
        if answer == "1":
            ...
            input()
            print("User File:")
            print("The Highest Buy Volume is:", max_stats(new_dict,"Buy Vol"))
            print("The Highest Buy Average is:", max_stats(new_dict,"Buy Avg"))
            print("The Highest Buy Max is:", max_stats(new_dict,"Buy Max"))
            print("The Highest Buy Min is:", max_stats(new_dict,"Buy Min"))
            print("The Highest Buy Standard Deviation is:", max_stats(new_dict,"Buy StdDev"))
            print("The Highest Buy Median is:", max_stats(new_dict,"Buy Median"))
            print("The Highest Buy Percentile is:", max_stats(new_dict,"Buy Percentile"))
            print("The Highest Sell Vol is:", max_stats(new_dict,"Sell Vol"))
            print("The Highest Sell Average is:", max_stats(new_dict,"Sell Avg"))
            print("The Highest Sell Max is:", max_stats(new_dict,"Sell Max"))
            print("The Highest Sell Min is:", max_stats(new_dict,"Sell Min"))
            print("The Highest Sell Standard Deviation is:", max_stats(new_dict,"Sell StdDev"))
            print("The Highest Sell Median is:", max_stats(new_dict,"Sell Median"))
            print("The Highest Sell Percentile is:", max_stats(new_dict,"Sell Percentile"))
            print("The Smallest Buy Volume is:", min_stats(new_dict,"Buy Vol"))
            print("The Smallest Buy Average is:", min_stats(new_dict,"Buy Avg"))
            print("The Smallest Buy Max is:", min_stats(new_dict,"Buy Max"))
            print("The Smallest Buy Min is:", min_stats(new_dict,"Buy Min"))
            print("The Smallest Buy Standard Deviation is:", min_stats(new_dict,"Buy StdDev"))
            print("The Smallest Buy Median is:", min_stats(new_dict,"Buy Median"))
            print("The Smallest Buy Percentile is:", min_stats(new_dict,"Buy Percentile"))
            print("The Smallest Sell Vol is:", min_stats(new_dict,"Sell Vol"))
            print("The Smallest Sell Average is:", min_stats(new_dict,"Sell Avg"))
            print("The Smallest Sell Max is:", min_stats(new_dict,"Sell Max"))
            print("The Smallest Sell Min is:", min_stats(new_dict,"Sell Min"))
            print("The Smallest Sell Standard Deviation is:", min_stats(new_dict,"Sell StdDev"))
            print("The Smallest Sell Median is:", min_stats(new_dict,"Sell Median"))
            print("The Smallest Sell Percentile is:", min_stats(new_dict,"Sell Percentile"))
        ...
        if answer == "2":
            ...
            input()
            print("User File: ")
            gen_stats(new_dict,"Buy Avg")
            print("This histogram is based on Buy Average.")
            print()
            gen_stats(new_dict,"Sell Avg")
            print("This histogram is based on Sell Average.")
            print()
            print("Press Enter to Go Back to the Option 1 Menu")
            input()
